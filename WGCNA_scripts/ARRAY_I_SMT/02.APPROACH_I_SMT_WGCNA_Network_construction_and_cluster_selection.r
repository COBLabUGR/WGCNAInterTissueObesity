...
sizeGrWindow(12,9)
plot(geneTree, xlab="", sub="", main = "Gene clustering on TOM-based dissimilarity in Skeletal Muscle Tissue ( input = 6000 probes )",
...
plotDendroAndColors(geneTree, dynamicColors, "Dynamic Tree Cut",
                    ...
                    main = "Gene dendrogram and module colors in Skeletal Muscle Tissue ( input = 6000 probes )")
