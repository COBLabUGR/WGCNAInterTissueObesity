...
workingDir = "/media/mireia/Disco Duro HDD/Documentos/R/ARRAY_Obesidad/Adiposo";
setwd(workingDir);
...
femData = read.csv("/media/mireia/Disco Duro HDD/Documentos/R/ARRAY_Obesidad/Adiposo/ARRAY_Obesidad_Adiposo.csv", header=TRUE, sep=";", stringsAsFactors=F, dec=",", na.strings=c(""," ","NaN","NA"),row.names=1);
...
#
#===============================================================================
traitData = read.csv2("bd_fenotipos_obesos_adiposo.csv", header=TRUE, sep=";", stringsAsFactors=F, dec=",", na.strings=c(""," ","NaN","NA"));
dim(traitData)
names(traitData)
...
plotDendroAndColors(sampleTree2, traitColors,
                    ...
                    main = "Sample dendrogram and trait heatmap in Adipose (input = 6000 probes)")
