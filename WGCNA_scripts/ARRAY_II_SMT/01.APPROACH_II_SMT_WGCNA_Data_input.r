...
femData = read.csv("/media/mireia/Disco Duro HDD/Documentos/R/ARRAY_Obesidad/Musculo/ARRAY_Obesidad_5_individuos.csv", header=TRUE, sep=";", stringsAsFactors=F, dec=",", na.strings=c(""," ","NaN","NA"),row.names=1);
...
rownames (datExpr0) = c("6","7","8","9","10")
