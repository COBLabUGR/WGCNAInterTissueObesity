...
workingDir = "/media/mireia/HardDiskHDD/Documentos/R/ARRAY_Obesidad/Musculo";
#workingDir = "D://Documentos/R/ARRAY_Obesidad/Musculo";
setwd(workingDir);
...
sizeGrWindow(12,9)
plot(geneTree, xlab="", sub="", main = "Gene clustering on TOM-based dissimilarity Obesity (input = 6000 probes)",
...
plotDendroAndColors(geneTree, dynamicColors, "Dynamic Tree Cut",
                    ...
                    main = "Gene dendrogram and module colors in Muscle (input = 6000 probes)")
...
# Plot the result
sizeGrWindow(7, 6)
plot(METree, main = "Clustering of module eigengenes in Skeletal Muscle Tissue ( input = 6000 probes )",
     xlab = "", sub = "")
