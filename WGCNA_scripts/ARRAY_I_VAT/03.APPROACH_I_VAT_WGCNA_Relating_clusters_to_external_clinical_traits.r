...
workingDir = "/media/mireia/HardDiskHDD/Documentos/R/ARRAY_adiposo_6000";
setwd(workingDir);
...
#               signifCutpoints = c(0, 0.001, 0.01, 0.05, 1),
               main = paste("Module-trait relationships in Visceral Adipose Tissue (input = 6000 probes)"))
...
names(datExpr)
names(datExpr)[moduleColors=="cyan"]
...
geneOrder = order(geneInfo0$moduleColor, -abs(geneInfo0$GS.zscore));
...
write.csv(geneInfo, file = "geneInfo_VAT_I.csv")
