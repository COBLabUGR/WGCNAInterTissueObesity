...
#
#===============================================================================
lightgreen <- read.csv2("/media/mireia/Disco Duro HDD/Documentos/R/ANALISIS_GO/MODULE_GENE_ID_ALL_ADIPOSO/lightgreen.csv", header=TRUE, sep=";", stringsAsFactors=F, dec=",", na.strings=c(""," ","NaN","NA"),row.names=1)
...
write.csv2(MERGED_, file="/media/mireia/Disco Duro HDD/Documentos/R/ANALISIS_GO/ENRICHMENT_RESULTS/ALL_ADIPOSE/ae_annot_simplificado_/ae_annot_simplificado_lightgreen.csv", row.names=TRUE)

write.csv2(TO_SAVES, file="/media/mireia/Disco Duro HDD/Documentos/R/ANALISIS_GO/ENRICHMENT_RESULTS/ALL_ADIPOSE/enrichmentGO/lightgreen_enrichmentGO.csv", row.names=TRUE)

write.csv2(TO_SAVES, file="/media/mireia/Disco Duro HDD/Documentos/R/ANALISIS_GO/ENRICHMENT_RESULTS/ALL_ADIPOSE/enrichmentKEGG/lightgreen_enrichmentKEGG.csv", row.names=TRUE)
